      ...
      {gameInfo && (() => {
        ...
        return (
          <div className={`absolute z-10 pointer-events-none flex flex-col items-center ${isFullscreen ? 'top-[max(env(safe-area-inset-top,0px)+10px,14px)] left-3' : 'top-2 left-2'}`}>
            {/* Row 1 — score (full width, rounded all corners) */}
            <div
            ...
            {/* Row 2 — narrower, same background, all corners rounded, slight overlap so it reads as one piece */}
            <div
              className="-mt-px rounded-2xl border border-white/15 shadow-lg backdrop-blur-md flex items-center gap-1.5 px-3 py-1"
              style={{ background: 'linear-gradient(135deg, rgba(15,15,18,0.92) 0%, rgba(28,28,32,0.88) 100%)' }}
            >
              {showLiveDot && (
