        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="relative block">
              <span className="text-xs font-semibold text-stone-500 mb-1 block">DATE *</span>
              <div className="w-full border border-stone-300 bg-white rounded-xl px-3 py-2.5 text-sm min-h-[42px] flex items-center">
            ...
            <label className="relative block">
              <span className="text-xs font-semibold text-stone-500 mb-1 block">TIME</span>
              <div className="w-full border border-stone-300 bg-white rounded-xl px-3 py-2.5 text-sm min-h-[42px] flex items-center">
