                ...
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    {[...(doc.player_stats || [])]
                      ...
                      .map(s => (
                        <React.Fragment key={s.player_id}>
                        <tr
                          className="border-b border-stone-800/50 cursor-pointer active:bg-stone-800/40"
                          onClick={() => setOpenHeatmap(openHeatmap === s.player_id ? null : s.player_id)}
                        >
                          <td className="py-1 pr-2 truncate max-w-[140px]">
                            <span className="text-stone-500 mr-1">{openHeatmap === s.player_id ? '▾' : '▸'}</span>
                        ...
                        {openHeatmap === s.player_id && (
                          <tr className="bg-stone-950/60 border-b border-stone-800/50">
