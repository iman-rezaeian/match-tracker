...
function VideoPlayer360({ videoUrl, seekTo, onClose, events = [] }) {
    ...
    <div className="relative bg-black rounded-2xl overflow-hidden border border-stone-800">
      ...
      <div className="px-3 py-2 flex items-center gap-2 bg-stone-900">
        ...
        <div className="flex-1 relative">
          ...
          />
          {duration > 0 && events.filter(e => e.elapsed > 0 && e.elapsed <= duration && e.type !== 'SUB' && e.type !== 'GK_CHANGE').map(e => {
    ...
    <div className="min-h-screen bg-stone-950 pb-12 relative">
      ...
      {game.liveInput?.hlsUrl && (
        <div className="px-4 pt-4 max-w-2xl mx-auto">
          ...
          <VideoPlayer360 videoUrl={game.liveInput.hlsUrl} events={[]} />
        </div>
      )}
      {!game.liveInput?.hlsUrl && game.videoUrl && (
        <div className="px-4 pt-4 max-w-2xl mx-auto">
          ...
          <VideoPlayer360 videoUrl={game.videoUrl} events={[]} />
        </div>
      )}
    </div>
  );
