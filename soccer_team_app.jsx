                ...
                {candidates.map(p => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-12 h-12 rounded-lg bg-amber-500 text-stone-900 flex items-center justify-center font-display text-2xl tabular-nums shrink-0">
                        {p.number || '—'}
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="font-bold text-sm truncate">{p.name}</div>
                        <div className="text-[10px] text-amber-700 font-bold tracking-wider">
                          {isDefault ? 'SUGGESTED' : (p.position === 'GK' ? 'DEFAULT GK' : (p.position || 'OUTFIELD'))}
                        </div>
                      </div>
                    </button>
                  );
