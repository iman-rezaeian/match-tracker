        ...
        return (
          <div className={`absolute z-10 pointer-events-none flex flex-col items-center ${isFullscreen ? 'top-[max(env(safe-area-inset-top,0px)+10px,14px)] left-3' : 'top-2 left-2'}`}>
            ...
            <div className="relative -mt-px">
              ...
              />
              {/* Row 2 — square top corners (so fillets meet flush), rounded bottom */}
              <div
                className="rounded-b-2xl shadow-lg border border-t-0 border-white/15 backdrop-blur-md flex items-center gap-1.5 px-3 py-1"
                style={{ background: bugBg }}
              >
                {showLiveDot && (
