 ...
 * All stats (distance, top speed, formation, GK positioning, identity, per-
 * event clips) are locked to coaches and live in the coach-side AnalyticsPanel.
 *
 * The on-screen overlay inside the videos already follows the same privacy
 * rule (first name + jersey number only — see _build_broadcast_events_index
 * in post_game/pipeline.py).
 */
function PublicAnalyticsCard({ game, roster: _roster }) {
  ...
  if (!analytics?.auto_highlights_url && !analytics?.tv_reel_url) return null;
